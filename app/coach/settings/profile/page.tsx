/**
 * /coach/settings/profile — your personal profile. Most fields live in
 ...
 * /coach/templates page where they already live.
 */

import Link from "next/link";
import { redirect } from "next/navigation";
import { eq } from "drizzle-orm";
import { ArrowLeft, ArrowRight, Mail, PenTool, UserRound } from "lucide-react";
...
export default async function ProfileSettingsPage() {
  ...
  // summary and link the signature/e-sig to /coach/templates.
    ...
    <main className="max-w-3xl mx-auto px-6 py-12 space-y-8">
      ...
      <section className="border border-tbb-line rounded-lg bg-white p-5 space-y-3 shadow-tbb-sm">
        <div className="flex items-center gap-3">
          ...
          <Link
            href="/coach/templates#email-signature"
      ...
      <section className="border border-tbb-line rounded-lg bg-white p-5 space-y-3 shadow-tbb-sm">
        <div className="flex items-center gap-3">
          ...
          <Link
            href="/coach/templates#e-signature"
            className="inline-flex items-center gap-1.5 text-xs font-bold uppercase tracking-tbb-caps px-3 py-2 rounded-pill border border-tbb-line text-tbb-navy hover:border-tbb-blue hover:text-tbb-blue shrink-0"
          >
            {hasESig ? "Edit" : "Upload"}
            <ArrowRight className="w-3.5 h-3.5" aria-hidden />
