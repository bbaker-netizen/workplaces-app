 ...
 * Workplaces setup.
 *
 * Companion to /business-builder/welcome (which is the workflow guide).
 */
  ...
  return (
    <main className="max-w-tbb-narrow mx-auto px-6 py-12 sm:py-16 space-y-12">
      ...
      <ModuleCard
        ...
        link="/business-builder/sessions"
      ...
      <ModuleCard
        ...
        link="/business-builder/soul-search"
      ...
      <section className="border-t border-tbb-line-soft pt-8 space-y-4">
        ...
        <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <ExternalToolCard
            ...
            why="Accounting, tax, and payment processing. The portal posts invoices to QBO; QBO does the rest. Connect once at /business-builder/profile/quickbooks."
